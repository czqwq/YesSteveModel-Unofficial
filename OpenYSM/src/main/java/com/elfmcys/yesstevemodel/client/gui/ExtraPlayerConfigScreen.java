...
public class ExtraPlayerConfigScreen extends Screen {
    ...
    public void init() {
        ...
        addRenderableWidget(new ConfigCheckBoxForge(guiLeft + 5, guiTop + 199, "disable_loading_state_screen", LoadingStateConfig.DISABLE_LOADING_STATE_SCREEN));
        addRenderableWidget(new ConfigCheckBoxForge(guiLeft + 5, guiTop + 221, "use_compatibility_renderer", GeneralConfig.USE_COMPATIBILITY_RENDERER));
        addRenderableWidget(new LoadingStateButton(guiLeft + 5, guiTop + 242));
    }
