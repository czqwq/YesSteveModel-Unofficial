...
import com.elfmcys.yesstevemodel.geckolib3.geo.GeoMeshRenderer;
    ...
    public static void onRenderHand(RenderHandEvent event) {
        ...
        player.getCapability(PlayerCapabilityProvider.PLAYER_CAP).ifPresent(cap -> {
            ...
            if (instance != null) {
                ...
                GeoMeshRenderer.renderMesh(buffer, poseStack.last(), modelAssembly.getAnimationBundle().getArmModel(), modelAssembly.getAnimationBundle().getArmModel().getBoneTransformData(), null, textureIndex, 3, event.getPackedLight(), OverlayTexture.NO_OVERLAY, 1.0f, 1.0f, 1.0f, 1.0f);
                poseStack.popPose();
            }
        });
    }
