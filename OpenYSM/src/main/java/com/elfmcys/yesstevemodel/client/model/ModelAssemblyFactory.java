...
public class ModelAssemblyFactory {
    ...
    public static ModelAssembly buildAssembly(ClientModelInfo clientModelInfo, boolean isPrimary) {
        ...
        ModelAssembly assembly = new ModelAssembly(
                ...
                buildTextureRegistry(clientModelInfo, textureList), textureList
        );
        if (isPrimary) {
    ...
    private static ModelDisplayAssets buildTextureRegistry(ClientModelInfo clientModelInfo, List<AbstractTexture> textureList) {
        ...
        return new ModelDisplayAssets(metadata != null ? metadata.getName() : StringPool.EMPTY, clientModelInfo.getAvatarTextures(), extraTextures);
    }
