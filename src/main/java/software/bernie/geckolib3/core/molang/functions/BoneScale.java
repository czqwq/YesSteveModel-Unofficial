...
public class BoneScale extends Function {

    public BoneScale(IValue[] values, String name) throws Exception {
        super(values, name);
    }
    ...
    @Override
    public double get() {
        return MolangPhysicsRuntime.boneScale((int) getArg(0), axis());
    }
